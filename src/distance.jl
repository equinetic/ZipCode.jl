...
"""
function coord_distance(lat1::AbstractFloat,
                        lon1::AbstractFloat,
                        lat2::AbstractFloat,
                        lon2::AbstractFloat;
...
coord_distance(coord1::Coordinate, coord2::Coordinate; kwargs...) =
    coord_distance(coord1[1], coord1[2], coord2[1], coord2[2]; kwargs...)

"""
```julia
haversine(lat1::AbstractFloat,
          lon1::AbstractFloat,
          lat2::AbstractFloat,
          lon2::AbstractFloat,
...
"""
function haversine(lat1::AbstractFloat,
                   lon1::AbstractFloat,
                   lat2::AbstractFloat,
                   lon2::AbstractFloat,
                   radius::AbstractFloat)
    ...
    radius * 2asin(min(1, sqrt(a)))
end

"""
```julia
flatpythagorean(lat1::AbstractFloat,
                lon1::AbstractFloat,
                lat2::AbstractFloat,
                lon2::AbstractFloat,
                radius::AbstractFloat)
...
"""
function flatpythagorean(lat1::AbstractFloat,
                         lon1::AbstractFloat,
                         lat2::AbstractFloat,
                         lon2::AbstractFloat,
                         radius::AbstractFloat)
    ...
    radius * sqrt(a^2 + b^2 - 2*a*b*cos(lon2-lon1))
end


"""
```julia
vincenty(lat1::AbstractFloat,
         lon1::AbstractFloat,
         lat2::AbstractFloat,
         lon2::AbstractFloat
...
"""
function vincenty(lat1::AbstractFloat,
                  lon1::AbstractFloat,
                  lat2::AbstractFloat,
                  lon2::AbstractFloat,
                  radiusA::AbstractFloat=EARTH_RADIUS_EQUATORIAL;
